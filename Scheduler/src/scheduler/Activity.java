...
public class Activity {
  ...
  public void serialize(Activity previous) { 
    if (previous.terminationTime > this.activationTime) //ถ้าเวลาสิ้นสุดของแอคแรกมากกว่าเวลาเริ่มต้นของแอคสอง(มันทำงานซ้อนกัน) -- จะต้องเซ็ทเวลาใหม่
      this.activationTime = previous.terminationTime;   //เซ็ทเวลาเริ่มต้นของแอคสองใหม่
    this.terminationTime = this.activationTime + this.duration;     //ต้องเซ็ทเวลาส้นสุดของแอคสองใหม่ด้วย
  }
